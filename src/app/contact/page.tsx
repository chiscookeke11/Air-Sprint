...
export default function ContactForm() {
  ...
  return (
   <div className="flex justify-center w-[90%] mx-auto py-12">
    <div className="flex">
     <form
      id="contact-form"
    ...
    >
      ...
      <div>
        <Button
          ...
          className=" bg-white hover:bg-gray-100 text-black w-fit font-bold py-3 px-4 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-0"
        >
          {isSubmitting ? (
            <>
